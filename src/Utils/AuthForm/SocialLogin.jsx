...
const SocialLogin = ({ onclick }) => {
    return (
        <button
            onClick={onclick}
            type="button"
            className="py-2 group border-2 hover:border-0 relative before:absolute before:w-[2px] before:h-[2px]  before:bg-red-500 before:left-0 before:top-0 hover:before:w-full before:transition-all duration-500 after:absolute after:w-[2px] after:h-[2px]  before:opacity-0 hover:before:opacity-100 after:opacity-0 hover:after:opacity-100 after:bg-red-500 after:right-0 after:bottom-0 hover:after:w-full after:transition-all  flex items-center justify-center gap-4 before:delay-200  bg-gray-200/50 rounded-lg text-lg"
        >

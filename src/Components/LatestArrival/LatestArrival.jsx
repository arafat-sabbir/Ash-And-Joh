...
const LatestArrival = () => {
   ...
   return (
      <section className="flex flex-col items-center w-full h-full mx-10">
         <h1 className="text-3xl font-semibold text-center my-10">
            Latest Arrival
         </h1>
         <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-items-center lg:grid-cols-4 xl:grid-cols-5 w-full h-full  ">
            {allProduct?.map((product, index) => (
               <div key={index} className="w-full h-full relative bg-white  border-2 p-2  rounded-lg shadow-[0_0_30px_#E6E6E6] dark:bg-gray-800 py-20 hover:border-black transition-all duration-300">

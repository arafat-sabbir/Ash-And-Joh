...
const UserProfile = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
      const updatedUserData = {username: e.target.username.value,profilePicture:e.target.profileImage.files[0]}
        const toastId = toast.loading("Updating Profile");
      console.log(updatedUserData,"from data");
        try {
          const res = await axiosSecure.put(`/user/updateUserData/${userData._id}`, updatedUserData, {
            headers: {
